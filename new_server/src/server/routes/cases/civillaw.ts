...
router.get('/bgbat', async (req: Request, res: Response) => {
	const recommendedCases = await Cases.find({ $and: [{ 'meta.ratingCount': { $gt: rating } }, categories, { subcategories: 'BGB AT' }] })
	const allCases = await Cases.find(categories)
	const result = {
		recommendedCases,
		allCases,
...
router.get('/schuldrechtat', async (req: Request, res: Response) => {
	const recommendedCases = await Cases.find({ $and: [{ 'meta.ratingCount': { $gt: rating } }, categories, { subcategories: 'Schuldrecht AT' }] })
	const allCases = await Cases.find(categories)
	const result = {
		recommendedCases,
		allCases,
...
router.get('/schuldrechtbt', async (req: Request, res: Response) => {
	const recommendedCases = await Cases.find({ $and: [{ 'meta.ratingCount': { $gt: rating } }, categories, { subcategories: 'Schuldrecht BT' }] })
	const allCases = await Cases.find(categories)
	const result = {
		recommendedCases,
		allCases,
...
router.get('/sachenrecht', async (req: Request, res: Response) => {
	const recommendedCases = await Cases.find({ $and: [{ 'meta.ratingCount': { $gt: rating } }, categories, { subcategories: 'Sachenrecht' }] })
	const allCases = await Cases.find(categories)
	const result = {
		recommendedCases,
		allCases,
...
router.get('/deliktsrecht', async (req: Request, res: Response) => {
	const recommendedCases = await Cases.find({ $and: [{ 'meta.ratingCount': { $gt: rating } }, categories, { subcategories: 'Deliktsrecht' }] })
	const allCases = await Cases.find(categories)
	const result = {
		recommendedCases,
		allCases,
...
router.get('/bereicherungsrecht', async (req: Request, res: Response) => {
	const recommendedCases = await Cases.find({ $and: [{ 'meta.ratingCount': { $gt: rating } }, categories, { subcategories: 'Bereicherungsrecht' }] })
	const allCases = await Cases.find(categories)
	const result = {
		recommendedCases,
		allCases,
